module github.com/ambientkit/ambient-template

go 1.17

require (
	github.com/ambientkit/ambient v0.0.0-20220130222009-2de3a3c95be2
	github.com/ambientkit/plugin v0.0.0-20220130222035-0acf1cfcf200
